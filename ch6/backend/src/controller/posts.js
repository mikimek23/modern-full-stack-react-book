...
export const newPost = async (req, res) => {
  ...
  try {
    const post = { title, contents, tags }
    const result = await createPost(req.auth.sub, post)
...
export const updatePosts = async (req, res) => {
  ...
  try {
    const post = { title, contents, tags }
    const result = await updatePost(req.auth.sub, postId, post)
...
export const deletePosts = async (req, res) => {
  const { postId } = req.params
  try {
    const result = await deletePost(req.auth.sub, postId)
