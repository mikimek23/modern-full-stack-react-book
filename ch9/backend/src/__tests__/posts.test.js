...
describe('creating posts', () => {
  ...
  test('with minimal parameters shoould succeed', async () => {
    const post = {
      title: 'only a title',
    }
    const createdPost = await createPost('000000000000000000000000', post)
...
describe('listing posts', () => {
  ...
  //   const posts = await listPostByAuthor(id)
  //   expect(posts.length).toBe(3)
  // })
  test('should be able to filter posts by tag', async () => {
    const posts = await listPostByTag('react')
...
describe('getting a single post', () => {
  ...
  test('should fail if the id not exist', async () => {
...
describe('updating a post', () => {
  test('should update the specified property', async () => {
    await updatePost('000000000000000000000001', createdSamplePosts[0]._id, {
      title: 'Test Author',
    })
